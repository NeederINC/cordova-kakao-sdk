...
function patchXcode(projectRoot) {
  ...
  try {
    ...
    // emulate cocoapods script 
    // ref: https://developers.kakao.com/docs/latest/ko/getting-started/sdk-ios#apply-sdk-cocoapods-picker
